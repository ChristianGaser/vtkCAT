...
//----------------------------------------------------------------------------
void
vtkInteractorStyleImage2D::StartZSliceMove()
{
...
void
vtkInteractorStyleImage2D::ZSliceMove()
{
  vtkRenderWindowInteractor *rwi = this->Interactor;
...
void
vtkInteractorStyleImage2D::ZSliceWheelForward()
{
...
void
vtkInteractorStyleImage2D::ZSliceWheelBackward()
{
...
void
vtkInteractorStyleImage2D::EndZSliceMove()
{
...
//----------------------------------------------------------------------------
void
vtkInteractorStyleImage2D::FullPage()
{
...
//----------------------------------------------------------------------------
void
vtkInteractorStyleImage2D::StartMeasure()
{
...
void
vtkInteractorStyleImage2D::Measure()
{
  this->InvokeEvent(vtkViewImage2DCommand::MeasureEvent, this);
}
void
vtkInteractorStyleImage2D::EndMeasure()
{
...
void
vtkInteractorStyleImage2D::WindowLevelWheelForward()
{
  int *size = this->View->GetRenderWindow()->GetSize();
...
void
vtkInteractorStyleImage2D::WindowLevelWheelBackward()
{
  int *size = this->View->GetRenderWindow()->GetSize();
